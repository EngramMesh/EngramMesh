"""PostgreSQL runtime outbox relay polling store."""
...
from engrammesh.modules.runtime.adapters.postgres.mappers import row_to_event
...
@final
class PostgresRuntimeOutboxRelayStore:
    """Poll unpublished runtime outbox rows and mark them published outside writes."""
